<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="{{ route('admin.orders.list', ['all']) }}" style="background-color: rgb(231, 231, 231);">
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics get-view-by-onclick card" href="{{route('admin.vendors.vendor-list')}}"  style="background-color: rgb(231, 231, 231);">
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card"  style="background-color: rgb(231, 231, 231);">
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="{{route('admin.customer.list')}}"  style="background-color: rgb(231, 231, 231);">
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="#"  style="background-color: rgb(231, 231, 231);"> <!-- Update route as necessary -->
        ...
        <h2 class="business-analytics__title">{{ $data['category']}}</h2>
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="#"  style="background-color: rgb(231, 231, 231);"> <!-- Update route as necessary -->
        <h5 class="business-analytics__subtitle">Total Brand</h5>
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="#"  style="background-color: rgb(231, 231, 231);"> <!-- Update route as necessary -->
        <h5 class="business-analytics__subtitle">Total Delivery Man</h5>
        <h2 class="business-analytics__title">{{ $data['delivery_man']}}</h2>
        {{-- <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/total-categories.png') }}" class="business-analytics__img" alt=""> --}}
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_pending" href="{{route('admin.orders.list',['pending'])}}"  style="background-color: rgb(231, 231, 231);">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_confirmed" href="{{route('admin.orders.list',['confirmed'])}}"  style="background-color: rgb(231, 231, 231);">
        <div class="order-stats__content">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_packaging" href="{{route('admin.orders.list',['processing'])}}"  style="background-color: rgb(231, 231, 231);">
        <div class="order-stats__content">
